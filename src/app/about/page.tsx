    ...
    <>
      ...
      <main className="mx-auto max-w-[680px] px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="article-body mt-8">
          ...
          <h2 className="headline mt-10 text-2xl">Illustrations</h2>
          <p>
            Each article is illustrated with a single pen-and-ink sketch,
            generated by OpenAI&rsquo;s <code>gpt-image-2</code> model at the
            same moment the story is filed. The subject is a physical
            real-world object drawn from the article&rsquo;s lede &mdash; a
            tanker, a dove, a pair of dice. There are no infographics, no
            maps, and no embedded text. A light-mode and dark-mode variant
            are derived from a single generation by remapping ink density
            against each palette, so the drawing is identical in both
            themes. Any article without a visible illustration is one whose
            generation failed; the paper ships the gap rather than holding
            the edition.
          </p>
