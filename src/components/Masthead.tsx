...
export function Masthead({ asPrimaryHeading = true }: MastheadProps) {
  const SiteTitle = asPrimaryHeading ? "h1" : "p";
  return (
    <header className="border-b-2 border-ink" role="banner">
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6 pt-6 pb-4 sm:pt-8">
        <SiteTitle className="text-center">
          <Link
            href="/"
